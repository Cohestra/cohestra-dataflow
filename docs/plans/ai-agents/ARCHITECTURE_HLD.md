...
Status: implementation design, 2026-09-14. Maintainer review accepted the agent planning direction in PRs [38](https://github.com/Cohestra/cohestra-dataflow/pull/38), [39](https://github.com/Cohestra/cohestra-dataflow/pull/39), and [40](https://github.com/Cohestra/cohestra-dataflow/pull/40). This document summarizes that direction; the [backend LLD](BACKEND_LLD.md) is authoritative for wire contracts and schema on any conflict; it does not claim that the proposed components have shipped or that the PRs have merged. Application baseline remains `857f36f51d9d58c05b32a4d2941448b1eeebbcbd`.
